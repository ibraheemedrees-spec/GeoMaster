...
class _SurveyConfigListScreenState extends State<SurveyConfigListScreen> {
  ...
  Future<void> _createDefaultsIfEmpty() async {
    ...
    final defaults = [
      ...
      SurveyConfig(name: 'RTK Rover - Radio', correctionSource: 'radio', quality: QualityLimits(requireRtkFixed: true)),
      SurveyConfig(name: 'RTK Base - Radio', correctionSource: 'base'),
      SurveyConfig(name: 'RTK Base - Network', correctionSource: 'base'),
    ];
